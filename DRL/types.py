...
class ActionType(str, Enum):
    ...
    RELEASE = "RELEASE"
    RESCAN = "RESCAN"
    SET_MODE_FAST = "SET_MODE_FAST"
    SET_MODE_SAFE = "SET_MODE_SAFE"
...
class Strategy(str, Enum):
    ...
    RESCAN_THEN_SAFE = "RESCAN_THEN_SAFE"
    FAST_THEN_RETRY_SAFE = "FAST_THEN_RETRY_SAFE"
...
class ObservationLayout:
    ...
    PHASE_START = 6
    PHASE_LEN = 6
    MODE_START = PHASE_START + PHASE_LEN
    MODE_LEN = 2
    REMAINING = MODE_START + MODE_LEN
    PLACED = REMAINING + 1
